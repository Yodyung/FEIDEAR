...
<!-- bootstrap-wysiwyg -->
<link
	href="<%=pjName%>/resources/assets/admin/vendors/google-code-prettify/bin/prettify.min.css"
	rel="stylesheet">
<!-- Select2 -->
<link
	href="<%=pjName%>/resources/assets/admin/vendors/select2/dist/css/select2.min.css"
	rel="stylesheet">
<!-- Switchery -->
<link
...
<!-- starrr -->
<link
	href="<%=pjName%>/resources/assets/admin/vendors/starrr/dist/starrr.css"
	rel="stylesheet">
